...
namespace eeTools\eeWechat\Payment\WAP;
...
class WapPay extends wcPayBaseData{
     ...
     * for native model
     */
    public function generateWAPUri(){
        $returnData = [];
        
        //load unifiedOrder by order.or_id, we need code_url here.
        $uo = new Unifiedorder(['o_id'=>$this->o_id]);
        //values
        $uo->createWapUnifiedOrder(PaymentMethod::PM_WECHATMOBILE);
        
        $returnData['wap_uri'] = $uo->code_url;
